...
* Get the installation package ([Download Release](https://github.com/jwise/HoRNDIS/releases/tag/rel9.2) or [Build](#Building-the-source-and-the-Package) the installation package from source yourself)
